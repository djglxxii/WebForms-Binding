...
interface AegisValidatedInput extends Components.AegisValidatedInput, HTMLElement {}
export const AegisValidatedInput: {
  prototype: AegisValidatedInput;
  new (): AegisValidatedInput;
};
